...
namespace simu
{
    ...
    class MazeCheckSpe: public Level
    {
...
public:
    ...
    const std::string getDescription() const override { return "Apprentissage de résolution de labyrinthe avec checkpoint et gestion des espèces."; };
